...
import type { SupportedLanguages, Namespaces } from '../index';
 ...
 */
export const useTranslation = (namespace?: Namespaces) => {
   ...
   */
  const isLanguageActive = (language: SupportedLanguages): boolean => {
   ...
   * @param options - Translation options
   */
  const translateFromNamespace = (ns: Namespaces, key: string, options?: any): string => {
